...
* **Multi-Tenant Cake House** - A Multi-Tenant app built with Appwrite and Refine [Website](https://refine.dev/docs/advanced-tutorials/multi-tenancy/appwrite/) | [Source Code](https://github.com/refinedev/refine/tree/master/examples/multi-tenancy/appwrite) ⭐ 35,729 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-10
...
* [Appwrite CLI](https://github.com/appwrite/sdk-for-cli) ⭐ 102 | 🐛 13 | 🌐 Go | 📅 2026-09-25 interact with your Appwrite server side APIs from your terminal.
