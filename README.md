...
* [Announcing Appwrite 0.14 with 11 Cloud Function Runtimes! :partying\_face:](https://dev.to/appwrite/announcing-appwrite-014-with-11-cloud-function-runtimes-36f5)
...
* [Day 16 - Database Design :monocle\_face:](https://dev.to/appwrite/30daysofappwrite-database-design-140a)
...
* [FoodMagic](https://github.com/Sameerkash/FoodMagic) ⭐ 73 | 🐛 4 | 🌐 Dart | 📅 2021-06-27
* [React Native Appwrite OAuth](https://github.com/DiegoBM/react-native-appwrite-oauth) ⭐ 24 | 🐛 2 | 🌐 TypeScript | 📅 2023-06-15
* [Dart Online Compiler](https://github.com/aadarshadhakalg/BLoC-Appwrite) ⭐ 21 | 🐛 2 | 🌐 Dart | 📅 2021-10-14
* [Todo With Flutter](https://github.com/SirusCodes/todo_appwrite) ⭐ 10 | 🐛 0 | 🌐 Dart | 📅 2021-05-26
* [Budgetist](https://github.com/intel-raja/budgetist_kakeibo#budgetist_kakeibo) ⭐ 7 | 🐛 0 | 🌐 Dart | 📅 2021-06-30
* [Flutter Appwrite Auth System](https://github.com/devkishor8007/Auth_System_Appwrite) ⭐ 5 | 🐛 0 | 🌐 Dart | 📅 2022-07-25
* [KnowYourFood](https://github.com/LeBraveLittleToaster/KnowYourFood) ⭐ 4 | 🐛 0 | 🌐 Dart | 📅 2021-07-01
* [Appwrite Todo With React Native](https://github.com/DiegoBM/appwrite-todo-with-react-native) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2021-05-31
* [Flutter Appwrite Todo](https://github.com/devkishor8007/todo-with-flutter/tree/todo_appwrite/flutter_appwrite) ⭐ 2 | 🐛 0 | 📅 2021-06-20
* [Toodo - Appwrite with Ionic](https://github.com/Hrdtr/toodo-app) ⚠️ Archived
...
* [Appwrite + Appcelerator Titanium: A step by step guide](https://github.com/m1ga/from_zero_to_app/blob/master/appwrite_app.md) ⭐ 50 | 🐛 2 | 📅 2022-05-12
...
* **Appwrite + Angular Todo MVC** A simple todo app built with Appwrite and Angular. [Source Code](https://github.com/appwrite/todo-with-angular) ⚠️ Archived [Demo](https://appwrite-todo-with-angular.vercel.app/)

* **Appwrite + Angular - Simple Blog** - A simple blog example using Angular as the frontend and Appwrite as the backend! [Source Code](https://github.com/NeonSpork/appwrite-blog-example) ⭐ 1 | 🐛 14 | 🌐 TypeScript | 📅 2023-02-04

* **Appwrite + Angular Transcript This** - A simple app to transcribe Youtube videos from their links. [Source Code](https://github.com/ffex/Transcript-This-Demo) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2022-11-04

* **Appwrite + Angular PodBook** - A simple app to trascript podcasts from RSS feed. [Source Code](https://github.com/ffex/PodBook) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2022-11-04

* **Appwrite + Angular SimpleGrocery** - A simple app to create fast shopping-list. [Source Code](https://github.com/ffex/simple-grocery-demo) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2021-10-30

* **Appwrite + Angular VideoTopics** - A simple app to search topic about a Youtube video. [Source Code](https://github.com/ffex/VideoTopics) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2022-11-04

### Cordova

* **Appwrite + Cordova + React** - A simple instagram clone built with Appwrite, Cordova and React (with vite). [Source Code](https://github.com/arnu515/instagram-clone-with-cordova-appwrite) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2022-11-10
...
* **Appwrite + ExpressJS** - A simple API made using Appwrite and ExpressJS. [Source Code](https://github.com/PyroCandy/pokemon-api-appwrite) ⭐ 0 | 🐛 0 | 🌐 HTML | 📅 2021-10-18 [Blog Post](https://medium.com/@rushilshekhar1_/making-a-simple-api-using-appwrite-a7ceb096bf8f)

* **Appwrite System Health** - A simple demo app to build an express nodejs rest api to monitor health on appwrite app. [Source Code](https://github.com/fernandoamz/node-express-server-rest-api) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2021-11-05 [Blog Post](https://dev.to/fernandoamz/appwrites-health-service-3lh7)

### Flutter

* **Flutter Appwrite Quiz App** A simple Quiz App built with Flutter and Appwrite [Source Code](https://github.com/appwrite/quiz-with-flutter) ⚠️ Archived

* **Flutter TODO App** - A TODO app with Flutter and Appwrite as a backend. [Source Code](https://github.com/Dev-Manny/Appwrite-Todo) ⭐ 26 | 🐛 0 | 🌐 Dart | 📅 2024-07-12

* **Artistry** - Artistry is a demo app built with flutter and Appwrite backend that demonstrates how to perform crud operation,searching, authentication with touch of cool animations. [Source Code](https://github.com/dvmjoshi/artistry_appwrite) ⭐ 22 | 🐛 0 | 🌐 Dart | 📅 2022-07-26

* **AppNote** - Flutter notes app using Appwrite as a backend for storing documents. [Source Code](https://github.com/netfirms/appnote) ⭐ 16 | 🐛 1 | 🌐 Dart | 📅 2020-05-28, [Blog Post](https://dev.to/netfirms/appwrite-and-flutter-example-app-42ce)

* **Flutter Appwrite Social App** A Social App playground for testing the features of Appwrite. [Source Code](https://github.com/alistairholmes/flutter-appwrite-social-app) ⭐ 9 | 🐛 0 | 🌐 Dart | 📅 2026-07-26

- Building **No Signal** - A chatting App using Flutter and Appwrite [Part 1](https://bishwajeet-techmaster.medium.com/building-no-signal-app-using-flutter-and-appwrite-8b31358b5975)| [Part 2](https://bishwajeet-parhi.medium.com/building-no-signal-using-flutter-and-appwrite-part-2-565c5eb3b484) | [Part 3](https://bishwajeet-parhi.medium.com/building-no-signal-using-flutter-and-appwrite-part-3-90b08db16ec) | [Source Code](https://github.com/2002Bishwajeet/no_signal) ⭐ 66 | 🐛 1 | 🌐 Dart | 📅 2024-06-02

* **Fitness Challenge App with Appwrite** - Create fitness challenges, invite friends, sync your health data from Apple Health/Google Fit and see who's winning. [Source Code](https://github.com/gireeshp/fitness_challenge) ⭐ 28 | 🐛 8 | 🌐 Dart | 📅 2021-10-29 [Blog Post](https://medium.com/@gireeshputhumana/building-the-fitness-challenge-app-with-appwrite-367286790f64)

* **Gradely 2 - Grade Calculator** - A grade calulator app where you can monitor and store your grades, built with Appwrite and Flutter. [Source Code](https://github.com/generalxhd/Gradely2) ⚠️ Archived

* **Simple Notes App** - A productivity mobile application to create notes [Source Code](https://github.com/davidnwaneri/simple_notes_app) ⭐ 9 | 🐛 1 | 🌐 Dart | 📅 2026-02-06

* **Online Store with Flutter and Appwrite** - An online store platform that connects users with nearby shops and small businesses. Includes realtime store details, in app notifications, inventory management and more [Blog Post](https://asutosh.hashnode.dev/building-an-online-store-platform-using-appwrite-and-flutter-localease) | [Tutorial](https://youtu.be/APp9dHVvmPg) | [Source Code](https://github.com/asutoshranjan/local-ease) ⭐ 8 | 🐛 0 | 🌐 Dart | 📅 2024-10-12

* **Almost Instagram with Flutter and Appwrite** - A functional clone of Instagram social media platform [Source Code](https://github.com/letsintegreat/Almost-Instagram) ⭐ 7 | 🐛 0 | 🌐 Dart | 📅 2022-10-19

* **Real-time Voting App** - The app of face-to-face voting at conferences with access control. Includes a Bloc state manager, dependency injection, and more [Source Code](https://github.com/mirea-ninja/voting-app) ⭐ 1 | 🐛 0 | 🌐 Dart | 📅 2023-10-17 | [Example Conference](https://vk.com/wall-78724646_1219)

* **Quit Smoking App with Flutter and Appwrite** - A simple Counting app with user auth [Source Code](https://github.com/Jonathanvanhaaften/flutter_appwrite_1) ⭐ 0 | 🐛 0 | 🌐 Dart | 📅 2021-10-30

### Godot

* **Godot + Appwrite** - A demo app to showcase Godot's integration with Appwrite. [Source Code](https://github.com/lohanidamodar/godot-appwrite) ⭐ 15 | 🐛 0 | 🌐 GAP | 📅 2021-05-09
...
* **Blog App** - A simple blog app built with Appwrite and Preact. [Source Code](https://github.com/Sooraj-s-98/Preact-appwrite-blog) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2022-10-22

### Python

* **Database interactions with the Python SDK demo** - A demonstration of using an Appwrite backend with a FastAPI python web application focussing on using pydantic as the interface with the Database. [Source Code](https://github.com/jhrcook/coffee-counter-appwrite-demo) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2021-10-17

* **Authenticate Appwrite User in Django** - A Django middleware to authenticate users with Appwrite. [Source Code](https://github.com/khashashin/django-appwrite) ⭐ 6 | 🐛 3 | 🌐 Python | 📅 2023-11-05

* **Anime list app with Appwrite and python-telegram-bot** - Created a telegram bot with python that handles searching and taking note of your anime watchlist. [Source Code](https://github.com/RobiMez/Better_anime_list) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2021-10-30

* **Discordly** A Discord-bot to readily and easily shorten links from Discord itself, made possible by Appwrite. [Source Code](https://github.com/Arpan-206/discordly) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2022-10-23

### React

* **Multi-Tenant Cake House** - A Multi-Tenant app built with Appwrite and Refine [Website](https://refine.dev/docs/advanced-tutorials/multi-tenancy/appwrite/) | [Source Code](https://github.com/refinedev/refine/tree/master/examples/multi-tenancy/appwrite) ⭐ 35,587 | 🐛 93 | 🌐 TypeScript | 📅 2026-06-05
...
* **Appwrite + NextJs +Nodejs Instagram clone** A instagram clone bulit with Appwrite , Nodejs and Nextjs. [Source Code](https://github.com/Sooraj-s-98/appwrite-instagram-clone) ⭐ 28 | 🐛 14 | 🌐 JavaScript | 📅 2022-09-18

* **Code-Snippets-Builder** - Drag and drop code snippet builder, effortlessly showcase your code in a visually appealing and professional manner. [Source Code](https://github.com/Sachin-chaurasiya/Code-Snippets-Builder) ⭐ 26 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-05 | [Blog Post](https://blog.sachinchaurasiya.dev//code-snippet-builder-create-stunning-code-snippets)

* **Event-Ally** - Event-Ally is an event management application where organizing and executing unforgettable events becomes effortless. [Source Code](https://github.com/Rohit-RA-2020/Task-Management) ⭐ 25 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-04 | [Blog Post](https://rohitranjan.hashnode.dev/event-ally-build-an-event-planning-platform-using-nextjs-appwrite) | [Video](https://youtu.be/CuI3aE7zN5Q)

* **useMindmap** - useMindmap is a mind mapping tool for individuals and teams to put their ideas or projects or whatever else a mind map can be used for. Built with React and Appwrite. [Source Code](https://github.com/benweier/use-mind-map) ⭐ 24 | 🐛 2 | 🌐 TypeScript | 📅 2022-05-18
...
* **Appwrite + React Google Drive Clone** - A simple google drive clone build with Appwrite and React. [Source Code](https://github.com/Emiliaaah/appwrite-auth-demo) ⚠️ Archived

* **Jobwrite** - Jobwrite is a React JS app that lets users find jobs that best match their GitHub profile. It uses NLP technique to analyse and match users with job openings, scrapped from the internet. Loaded with features like GitHub OAuth, filter jobs and feedback options all possible with Appwrite. [Source Code](https://github.com/Dksie09/JobwriteYT) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2023-08-24 [Blog post](https://duckshie.notion.site/Building-Jobwrite-A-Smart-Job-Search-Platform-using-React-and-Appwrite-21f98b37c7054af3917df6ef1ff1c522?pvs=4) [Video tutorial](https://youtu.be/9z_Rz-13Hm0)

* **Infinite Scrolling with React + Appwrite** - A simple project to demonstrate infinite scroll paging. [Source Code](https://github.com/SakshiUppoor/infinite-scroll-demo) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-24

* **Taskly - better way to manage your tasks** - An app to better manage tasks across all of the different task/todo/issue/project applications. Connect all of your 3party task providers, save time and focus on actually doing your job. [Website](https://taskly.kickass.website/), [Blog post](https://dev.to/capjavert/taskly-better-way-to-manage-your-tasks-2d2m), [Source Code](https://github.com/kickassCoderz/taskly) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2022-05-13

* **Snake Arcade** - A retro themed snake game with a live highscore board built in React using Appwrite Database and Realtime feature. [Blog Post](https://dev.to/anomic30/retro-themed-snake-game-with-live-highscore-board-2lei) | [Demo](https://snake-arcade-bck7y.ondigitalocean.app/) | [Source Code](https://github.com/anomic30/Snake-arcade) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2022-04-29

* **Next Appwrite Users** - App that showcases how to use Next.js with Appwrite as its backend. Uses Appwrite for Auth both on the frontend and on API routes. [Source code](https://github.com/RobRuizR/next-appwrite-users) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2022-10-23

* **User Auth** - User auth is a simple user authentication for web applications. It was made as a guide for your next application. [Source Code](https://github.com/HelixHEX/reactjs-appwrite_userauth) ⭐ 5 | 🐛 22 | 🌐 CSS | 📅 2023-01-05, [Blog Post](https://medium.com/@e.wambugu192/user-authentication-with-react-js-and-appwrite-30c9096e92b2)

* **Shuttery** - Shuttery is a web app which fetches and lets you download beautiful pictures from Unsplash to satisfy all your artistic needs. Secure App, with Google OAuth using an Appwrite backend. [Source Code](https://github.com/muKaustav/Appwrite-DemoApp-Hacktoberfest-2021) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-12

* **Made with Appwrite (Next.js)** This project can be used to collect information about projects which are built using Appwrite and can also be a place of a showcase for such projects. Built with Next.js and Appwrite. [Source Code](https://github.com/harisarang/madewithappwrite) ⭐ 4 | 🐛 1 | 🌐 JavaScript | 📅 2021-10-29 [Demo](https://madewithappwrite.vercel.app/) [Tutorial](https://dev.to/harisarang/build-a-web-app-using-nextjs-and-appwrite-4a0l)

* **Tourpal** - Tourpal is a travel journal web app in which you can store all your travel experiences at one place. The app is built with ReactJs and Appwrite. At the same time, it is a completely secure app and uses Google authentication. [Source Code](https://github.com/drishtipeshwani/Tourpal) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-27

* **Appwrite + NextJs Social Media App** A Social Media App built with Appwrite and Nextjs. [Source Code](https://github.com/SanjayDevTech/appwrite-nextjs-demo) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2022-11-01

* **ScheduMate** - A web application that allows you to easily see the classes that you have in common with your friends. Friends make classes so much better! [Website](https://schedumate.study) | [Source Code](https://github.com/The-Powerpuff-Boys/schedu-mate) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2023-08-10

* **Taskwrite** -Taskwrite is a demo web app built with React JS and Appwrite backend for Hacktoberfest 2021, that demonstrates how to create a To-Do list, that lets users add, edit, and delete tasks. It demonstrates the use of Google OAuth and Database Management. [Source Code](https://github.com/muKaustav/Taskwrite-Appwrite-Hacktoberfest-2021) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-18

* **OAuth Provider Tester** - A Simple Appwrite OAuth Tester App built to make new oauth provider testing easy. [Source Code](https://github.com/AmreshSinha/OAuth-Tester-Appwrite) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-18

* **React TODO App** - React + Appwrite TODO App Demo by @christyjacob4. [Source Code](https://github.com/christyjacob4/todomvc-react) ⭐ 2 | 🐛 23 | 🌐 JavaScript | 📅 2023-01-04

* **Quiz App (ReactJS and Appwrite)** - A demo web application built using React and integrated with Appwrite. [Source Code](https://github.com/shreyventure/quiz_app_write) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-06

* **Notes App with React + Appwrite** - A notes web app demo built with React and Appwrite. [Source Code](https://github.com/kunals131/notes-app-appwrite) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-17

* **Store your meds** - Is a mobile app that let's you organize your medicines at one place. Built using React Native, Expo and Appwrite. [Source Code](https://github.com/Neeleshrj/store-your-meds.git) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2022-10-14

* **Appwrite + NextJs Blog App** A Simple Blog App built with Appwrite and Nextjs. [Source Code](https://github.com/alceil/apppwrite-blogapp-with-nextjs) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-27

* **Login Page App with React and Appwrite** - Created an App with complete tutorial [Source Code](https://github.com/kunals131/Login-App-With-Appwrite) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-29

* **Pastebin Clone built with Appwrite** - A simple pastebin clone built in React with Appwrite using Google OAuth for Authentication [Source Code](https://github.com/dro-1/appwrite-pastebin-clone) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-31

* **Chatwrite** -- A simple, no-login chat app made with Appwrite and React. [Source Code](https://github.com/DarthFloopy/Chatwrite) ⭐ 0 | 🐛 6 | 🌐 TypeScript | 📅 2023-01-07
...
* **Listr** - A react native mobile application that allows for simple task management using lists | [Source Code](https://github.com/HelixHEX/listr) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2022-10-31

### Svelte

* **OmniaWrite** - OmniaWrite is a next-generation plain text editor engineered for creative writing. It is perfect for writing novels, lyrics, poems, essays, drafts and screenplays. [Source Code](https://github.com/TorstenDittmann/OmniaWrite) ⚠️ Archived, [Blog Post](https://omniawrite.com/posts/update-1-0-0)

* **Appwrite + Svelte Todo MVC** A simple todo app built with Appwrite and Svelte. [Source Code](https://github.com/appwrite/todo-with-svelte) ⚠️ Archived [Demo](https://appwrite-todo-with-svelte.vercel.app/)

* **Login Page using Appwrite + Svelte** - A login/register page to showcase Appwrite's JS API with Svelte. [Source Code](https://github.com/PineappleIOnic/appwrite-svelte) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2020-09-09

* **TMStats** A medal tracker for game Trackmania made with Appwrite and Svelte Kit. [Source Code](https://github.com/meldiron/tmstats) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-26 [Demo](https://www.tmstats.eu/)

* **To You** - Another to-do app, where completing tasks lead to great rewards. Leverages SvelteKit progressive enhancement features to enable a zero-JS experience. [Source Code](https://github.com/tglide/to-you) ⭐ 2 | 🐛 0 | 🌐 CSS | 📅 2023-01-12, [Demo](https://to-you-tgl.vercel.app/)

* **App-ly** App-ly is an open-source URL shortener made using Svelte and Appwrite. It is a web app that allows you to shorten long URLs, share them, and generate QR Codes for them. [Source Code](https://github.com/Arpan-206/app-ly) ⭐ 0 | 🐛 0 | 🌐 Svelte | 📅 2022-10-16

### Vue

* **Appwrite + Vue Todo MVC** A simple todo app built with Appwrite and Vue. [Source Code](https://github.com/appwrite/todo-with-vue) ⚠️ Archived [Demo](https://appwrite-todo-with-vue.vercel.app/)

* **nuxt3-appwrite package** A package to simply implement Appwrite in your Nuxt 3 project. Composable, Routes guards & no config needed. [Source Code](https://github.com/YsarocK/nuxt-appwrite) ⭐ 24 | 🐛 6 | 🌐 TypeScript | 📅 2024-11-25, [Documentation](https://nuxt-appwrite.etiennemoureton.fr)

* **Tailwinder** This an open-source complete community website project created for Appwrite hackathon. [Source Code](https://github.com/MooseSaeed/Tailwinder) ⭐ 19 | 🐛 0 | 🌐 Vue | 📅 2022-05-12 [Demo](https://dev.to/moose_said/introducing-tailwinder-home-for-tailwind-fans-powered-with-appwrite-4c0o) [Video Demo](https://vimeo.com/manage/videos/709162501)
...
* **Wishlist** An open-source wishlist app, created as an alternative to Amazon Wishlists or a simple Google doc [Source Code](https://github.com/JackBailey/Wishlist) ⭐ 3 | 🐛 5 | 🌐 Vue | 📅 2026-06-10

* **(Appwrite + Nuxt) DeUrl** A simple URL Shortener app made with appwrite and NuxtJs. [Source Code](https://github.com/AVDiv/appwrite_nuxtjs_url_shortner) ⭐ 2 | 🐛 0 | 🌐 Vue | 📅 2023-03-05

* **Appwrite + Vue Podcast Transcript** A simple Podcast Transcript app built with Appwrite, Deepgram and Vue. [Source Code](https://github.com/timothee-durand/appwrite-transcript) ⭐ 0 | 🐛 0 | 🌐 Vue | 📅 2022-11-07

### Android

* **Appwrite + Kotlin Android App -> Taleia** - A simple app that generates sets of random word combinations to fight the writer's block. It Allows to log in and save them with Appwrite to be able to retreive the liked combinations later. [Source Code](https://github.com/und1n3/taleia) ⭐ 2 | 🐛 2 | 🌐 Kotlin | 📅 2021-11-20

### Unity

* **Unofficial Appwrite Unity Plugin** Features include: login, register, send verification mails and request JWT's. [Source Code](https://github.com/AlexMeesters/unity-appwrite-plugin) ⚠️ Archived
...
* **SOS App** - A cross-platform mobile app built with .NET MAUI that allows the user to send an SOS message with their location to a saved phone number in times of distress using an Appwrite Function, Radar, and Twilio. [Source Code](https://github.com/adityaoberai/SOS-MAUI) ⭐ 34 | 🐛 4 | 🌐 C# | 📅 2023-02-09
...
* [Playground for Android](https://github.com/appwrite/playground-for-android) ⭐ 71 | 🐛 2 | 🌐 Kotlin | 📅 2026-05-14
* [Playground for Deno](https://github.com/appwrite/playground-for-deno) ⭐ 34 | 🐛 0 | 🌐 TypeScript | 📅 2024-09-19
* [Playground for Android with Retrofit](https://github.com/subhav13/Appwrite-Playground-for-Android-with-Retrofit) ⭐ 0 | 🐛 0 | 🌐 Java | 📅 2020-10-03
...
* [Appwrite Flutter SDK](https://github.com/appwrite/sdk-for-flutter) ⭐ 417 | 🐛 21 | 🌐 Dart | 📅 2026-08-24
* [Appwrite Web SDK](https://github.com/appwrite/sdk-for-web) ⭐ 334 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-13
* [Appwrite Python SDK](https://github.com/appwrite/sdk-for-python) ⭐ 268 | 🐛 10 | 🌐 Python | 📅 2026-08-27
* [Appwrite Node.js SDK](https://github.com/appwrite/sdk-for-node) ⭐ 257 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-27
* [Appwrite Android SDK](https://github.com/appwrite/sdk-for-android) ⭐ 154 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-26
* [Appwrite PHP SDK](https://github.com/appwrite/sdk-for-php) ⭐ 154 | 🐛 3 | 🌐 PHP | 📅 2026-08-27
* [Appwrite .NET SDK](https://github.com/appwrite/sdk-for-dotnet) ⭐ 128 | 🐛 3 | 🌐 C# | 📅 2026-08-27 (beta)
* [Appwrite Apple SDK](https://github.com/appwrite/sdk-for-apple) ⭐ 123 | 🐛 4 | 🌐 Swift | 📅 2026-07-13
* [Appwrite Dart SDK](https://github.com/appwrite/sdk-for-dart) ⭐ 118 | 🐛 10 | 🌐 Dart | 📅 2026-08-27
* [Appwrite Kotlin SDK](https://github.com/appwrite/sdk-for-kotlin) ⭐ 91 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-27
* [Appwrite Deno SDK](https://github.com/appwrite/sdk-for-deno) ⭐ 81 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-15
* [Appwrite Ruby SDK](https://github.com/appwrite/sdk-for-ruby) ⭐ 64 | 🐛 3 | 🌐 Ruby | 📅 2026-08-27
* [Appwrite Swift SDK](https://github.com/appwrite/sdk-for-swift) ⭐ 55 | 🐛 4 | 🌐 Swift | 📅 2026-08-27

### Community-Built SDKs

* [Unofficial Appwrite Godot Engine SDK](https://github.com/GodotNuts/appwrite-sdk) ⭐ 55 | 🐛 1 | 🌐 GDScript | 📅 2022-11-19
* [Unoffical Appwrite Minecraft SDK](https://github.com/nCodesDotEU/Appwrite-Minecraft-Database) ⭐ 15 | 🐛 1 | 🌐 Java | 📅 2021-11-20
* [Appwrite Appcelerator Titanium SDK](https://github.com/m1ga/ti.appwrite) ⭐ 8 | 🐛 0 | 🌐 Java | 📅 2022-05-19
* [Unofficial Appwrite Qt Framework SDK](https://github.com/qappwrite/qappwrite)

## Tools

* [Appwrite CLI](https://github.com/appwrite/sdk-for-cli) ⭐ 101 | 🐛 11 | 🌐 Go | 📅 2026-08-25 interact with your Appwrite server side APIs from your terminal.
...
* [Appwrite Funcover](https://github.com/BoolCode/appwrite-funcover) ⚠️ Archived "Cover" your Appwrite G3 functions with a dedicated endpoint, for static pages, direct execution and more.
* [AdminWrite](https://github.com/singhbhaskar/AdminWrite) ⭐ 9 | 🐛 1 | 🌐 Svelte | 📅 2023-05-10 helper tool for Appwrite to perform bulk operations during development for Database and Users.
